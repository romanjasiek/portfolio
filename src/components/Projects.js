        ...
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          <div className="col">
            <div className="card shadow-sm">
              <img className="projects__image" src={MusicEvangelists} alt="Music Evangelists Screenshot" />
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={MonochromeReflections} alt="Monochrome Reflections Screenshot" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={Avalost} alt="AVALOST Screenshot" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={Schottenschulle} alt="Schottenschulle Screenshot" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={GuidingLight} alt="Guiding Light Screenshot" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={PirpleHomework} alt="Pirple.com Homework Screenshot" />
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="btn-group">
                    ...
                    <button type="button" className="button button--secondary button--small"><a href="https://romanjasiek.github.io/project_frontend/" target="blank" rel="noreferrer">Repo: <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={BasicPortfolio} alt="Basic Portfolio Screenshot" />
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <button type="button" className="button button--secondary button--small"><a href="https://romanjasiek.github.io/ui-basics-portfolio-project-romanjasiek/" target="blank" rel="noreferrer">View</a></button>
                    <button type="button" className="button button--secondary button--small"><a href="https://github.com/romanjasiek/ui-basics-portfolio-project-romanjasiek" target="blank" rel="noreferrer">Repo: <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col">
            <div className="card shadow-sm">
            <img className="projects__image" src={PhotoProject} alt="Photography / Portfolio Screenshot" />
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <button type="button" className="button button--secondary button--small"><a href="https://romanjasiek.github.io/photo_project/" target="blank" rel="noreferrer">View</a></button>
                    <button type="button" className="button button--secondary button--small"><a href="https://github.com/romanjasiek/photo_project" target="blank" rel="noreferrer">Repo: <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col">
            ...
            <img className="projects__image" loading="lazy" src={ReactLogo} alt="React Logo" />
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="btn-group">
                    <button type="button" className="button button--secondary button--small"><a href="https://github.com/romanjasiek/React-To-Do-App" target="blank" rel="noreferrer">Repo: <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="btn-group">
                    ...
                    <button type="button" className="button button--secondary button--small"><a href="https://github.com/romanjasiek/vague-music-player" target="blank" rel="noreferrer">Repo: <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></button>
                  </div>
                </div>
              </div>
            </div>

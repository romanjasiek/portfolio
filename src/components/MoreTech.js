        ...
        <div className="container px-4 py-5" id="icon-grid">
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
              ...
              <FontAwesomeIcon icon={faApple}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">MacOS Big Sur</h4>
              ...
              <FontAwesomeIcon icon={faWindows}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Visual Studio Code</h4>
              ...
              <FontAwesomeIcon icon={faImage}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Adobe Photoshop 2021</h4>
              ...
              <FontAwesomeIcon icon={faCameraRetro}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Adobe Lightroom</h4>
              ...
              <FontAwesomeIcon icon={faImages}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Sony Alpha 7</h4>
              ...
              <FontAwesomeIcon icon={faSlack}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Slack</h4>
              ...
              <FontAwesomeIcon icon={faStackOverflow}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Stack Overflow</h4>
              ...
              <FontAwesomeIcon icon={faSpotify}/>&nbsp;
                <div>
                  <h4 className="fw-bold mb-0 fading">Spotify</h4>
